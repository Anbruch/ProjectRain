...
public class Assets implements Disposable, AssetErrorListener {
	...
	public void init(AssetManager assetManager) {
		...
		assetManager.load("images/ProjectRain2.pack", TextureAtlas.class);
		assetManager.load("music/World0.mp3", Music.class);
		assetManager.finishLoading();

		TextureAtlas atlas = assetManager.get("images/ProjectRain2.pack");
	...
	public void init(AssetManager assetManager, Array<String> path, boolean ui) {
		...
		atlasMap.add((TextureAtlas) (assetManager.get("images/ProjectRain2.pack")));
	...
	public class Rogue {
		...
		public final Array<AtlasRegion> fireBall;
		public final Animation aniFireBall;
		...
		public Rogue(TextureAtlas atlas) {
			...
			fireBall = atlas.findRegions("fireball");
			aniFireBall = new Animation(1/ 10.f, fireBall, Animation.LOOP);
