...
public class LevelStage {
	...
	public void render(SpriteBatch batch){
		...
		for(Ability cur : World.controller.activeAbilities){
			cur.render(batch);
		}
	...
	public void update(float deltaTime){
		...
		//Update abilities
		for(int i = 0; i < World.controller.activeAbilities.size; i ++){
			Ability curAbility = World.controller.activeAbilities.get(i);
			
			curAbility.update(deltaTime);
			if(curAbility.over)
				World.controller.activeAbilities.removeValue(curAbility, true);
